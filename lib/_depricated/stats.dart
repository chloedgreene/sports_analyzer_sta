...
class Stats extends StatelessWidget with GetItMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // final ratioToScoreToMiss =
    //     (totalbasckets / totalmiss) * 10; //get percentage
    ...
    //                   PieChartSectionData(
    //                       value: totalPoints / totalbasckets,
    //                       color: Colors.green),
    //                   PieChartSectionData(
    //                       value: totalPoints / totalmiss, color: Colors.red),
    //                   PieChartSectionData(
    //                       value: totalPoints / totalfouls,
    //                       color: Colors.yellow),
    //                 ]),
    ...
    //           }),
    //           Text(
    //               "Sucessfuull Score Percenentage: $ratioToScoreToMiss", // learn how to spell later
    //               style: const TextStyle(fontSize: 18)),
    //         ],
    //       )
    //     ],
